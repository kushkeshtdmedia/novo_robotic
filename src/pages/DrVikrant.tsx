      ...
      <section className="py-20 lg:py-28">
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <div>
            ...
            <p className="mt-5 text-[#3e484a] leading-relaxed max-w-md">
              Take the first step towards high-precision care. Dr. Sharma and his clinical team will
              review your case and recommend the most effective surgical pathway.
            </p>

            <div className="mt-10 space-y-6">
              <div className="flex items-start gap-4">
                <Phone className="w-5 h-5 text-[#0d7481] mt-1" strokeWidth={2} />
                <div>
                  <p className="font-[IBM_Plex_Sans] text-[10px] font-bold uppercase tracking-[0.1em] text-[#6e797b]">
                    Emergency Line
                  </p>
                  <a href="tel:+911800787437" className="text-lg font-bold hover:text-[#0d7481] transition-colors">
                    +91 1800-SURGERY
                  </a>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <Mail className="w-5 h-5 text-[#0d7481] mt-1" strokeWidth={2} />
                <div>
                  <p className="font-[IBM_Plex_Sans] text-[10px] font-bold uppercase tracking-[0.1em] text-[#6e797b]">
                    General Enquiries
                  </p>
          ...
          <div className="rounded-xl bg-white p-8 lg:p-10 shadow-[0px_10px_40px_rgba(0,0,0,0.04)]">
            ...
            <div className="mt-5">
              ...
              >
                ...
                <option value="gi">GI &amp; hepatobiliary</option>
                <option value="onco">Oncological surgery</option>
                <option value="gynae">Robotic gynaecology</option>
            ...
            <button
              type="button"
              className="mt-7 w-full inline-flex items-center justify-center gap-2 rounded-lg bg-[#0d7481] px-6 py-4 text-sm font-bold text-white hover:bg-[#005a65] transition-colors"
            >
              Submit inquiry <ArrowRight className="w-4 h-4" strokeWidth={2} />
            </button>

            <p className="mt-4 text-center font-[IBM_Plex_Sans] text-[10px] text-[#6e797b]">
              Your information is protected under our medical privacy standards.
            </p>
          </div>
        </div>
      </section>
